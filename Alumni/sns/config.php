...
//Ucenter Home配置参数
$_SC = array();
$_SC['dbhost']  		= '192.168.1.5'; //服务器地址
$_SC['dbuser']  		= 'eppstudio'; //用户
$_SC['dbpw'] 	 		= 'epp123@#$epp'; //密码
$_SC['dbcharset'] 		= 'utf8'; //字符集
$_SC['pconnect'] 		= 0; //是否持续连接
$_SC['dbname']  		= 'Alumni2012'; //数据库
$_SC['tablepre'] 		= 'sns_'; //表名前缀
...
define('UC_DBHOST', '192.168.1.5'); // UCenter 数据库主机
define('UC_DBUSER', 'eppstudio'); // UCenter 数据库用户名
define('UC_DBPW', 'epp123@#$epp'); // UCenter 数据库密码
define('UC_DBNAME', 'Alumni2012'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`Alumni2012`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'Kbq7JbDdp2A9q9g8Cbqbbbt9e9Caaaobme3eF819K5u5J5Ra66g4U406hcG3v78a'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://alumni.alumni2012.com/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
